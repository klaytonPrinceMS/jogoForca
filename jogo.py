import random as aleatorio, os as so, datetime as data
#teste
TELA =[
    '''
    ****************************************************************************************************************
...
def mostraTela(key,palavraSecreta,placarRecorde,placar,totaAcertos,palpites,ponto,palpitesFeitos):
    ...
    so.system('clear')
    print(TELA[0])
    print(f' PONTOS EM JOGO: {ponto} \n Seu placar: {placar} Recorde {placarRecorde} \n Acertos: {totaAcertos}   Palpites Feitos: {palpitesFeitos}\n Dica: %s \n')
...
def pegaLetra(palpitesFeitos):
	'''
	Verificar se o palpite possui apenas uma letra, não deve ter outros caracteres nem aceitar palavras com acentuação grafica
